...
public class EditorDiagram extends UserDataHolderBase implements FileEditor, FileListener {
    ...
    public EditorDiagram(VirtualFile file, Project project) throws IOException {
